...
<main class="form-signin mt-5 mb-5 w-100 m-auto">
	<form id="regForm" action="/review/insert" method="post" style="width:50em;" class="m-auto">
		<fieldset>
			...
			<div class="form-floating mb-3">
				<input type="text" class="form-control rounded-3" id="floatingInput" name="mov_rev_title" placeholder="리뷰 제목" /> 
				<label for="floatingInput" class="fw-bold">리뷰 제목</label>
			</div>
			<div class="form-floating mb-3">
				<textarea class="form-control rounded-3" name="mov_rev_content" placeholder="리뷰 내용" style="height:250px;" ></textarea>
			...
			<input type="hidden" name="mem_num" value="<c:out value="${principal.member.mem_num}"/>"  readonly/>
